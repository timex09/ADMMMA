...
clearvars;
clc;
pattern = 'promoter_commercial';
weekend = '';
ev_data = ['EV_data_' pattern weekend '.mat'];
load(ev_data);
...
save([pwd '\ev_profiles\' 'EV_' pattern '_' type '_' num2str(charge_power) '_' num2str(year) '.mat'],'EV_occurrence','EV_daily_demand', ...
